...
export type SDFNode =
  ...
  | { kind: 'revolve'; profile: PolygonProfile; axis: 'x' | 'y' | 'z'; angle: number; plane?: 'xy' | 'xz' | 'yz'; warn?: boolean }
  ...
  | { kind: 'twist'; child: SDFNode; axis: 'x' | 'y' | 'z'; angle: number; origin: number; extent: number; warn?: boolean }
  | { kind: 'bend'; child: SDFNode; axis: 'x' | 'y' | 'z'; direction: 'x' | 'y' | 'z'; angle: number; origin: number; extent: number; warn?: boolean }
