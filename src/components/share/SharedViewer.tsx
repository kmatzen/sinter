  ...
  useEffect(() => {
    ...
    async function load(provider: ProviderName, id: string) {
      try {
        ...
        useProjectStore.getState().loadLocalDocument('Shared project', tree, body.parameters, body.views, body.measurements, body.units, body.components, body.configurations, body.activeConfigurationId);
