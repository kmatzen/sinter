...
### Modeling
- **Primitives**: Box, Sphere, Cylinder, Torus, Cone, Capsule, Ellipsoid, visually editable polygon-profile extrusion (XY/XZ/YZ planes; symmetric/one-sided/two-sided; taper; thin wall) and revolve, with closed SVG and ASCII DXF profile import
