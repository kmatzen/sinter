...
### Modeling
- **Primitives**: Box, Sphere, Cylinder, Torus, Cone, Capsule, Ellipsoid, visually editable polygon-profile extrusion and revolve, with closed SVG and ASCII DXF profile import
